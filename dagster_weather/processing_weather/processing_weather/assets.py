...
# Assuming the settings.py file has the MongoDB settings
...
# Asset 3:transform the clean data into csv
@asset
def transform_to_csv(context, cleaned_df):
    df = cleaned_df
    ...
    return df  # Return the DataFrame, not the CSV path, for use in the next asset


# Asset 4: Save data to Delta Lake (Parquet format)
@asset
...
# Asset 5: Query a previous version of the Delta table
@asset
...
# Asset 6: Analyze the data (average temperature and humidity)
@asset
...
# Asset 7: Generate Visualizations (Line chart, Bar chart, Pie chart)
@asset
